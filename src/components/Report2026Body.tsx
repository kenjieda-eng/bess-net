  ...
  return (
    <div className="report-body" style={{ marginTop: 40 }}>
      ...
      <section>
        ...
        <p style={P}>
          2020年代前半、日本の系統用蓄電池は「制度をつくる時期」だった。容量市場が立ち上がり（初回メインオークションは2020年度実施・対象実需給年度2024年度）、需給調整市場が段階的に開設され、応札年度 2023年度には長期脱炭素電源オークションが始まった。これらにより、蓄電池は「実証・補助頼み」から「市場で稼ぐ事業」へと性格を変えた。
        </p>
        <p style={P}>
