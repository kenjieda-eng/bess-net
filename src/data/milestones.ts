...
export const MILESTONES: MilestoneData[] = [
  {
    ...
    achievements: [
      ...
      },
      {
        ...
        detail:
          'リン (data.eic-jp.org 編集長) との Phase D 第 1 期連動。catalog 124 系列引用、JEPX 10 + JMA 63 + 燃料 7 + FX 4 + JGB 1 + METI 12 + 米 Treasury 4 + 容量市場 11 系列の業界中立データ提供基盤',
        metric: 'catalog 124 系列',
      },
      {
