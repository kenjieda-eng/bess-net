  ...
  },
  {
    ...
    achievements: [
      ...
      },
      {
        ...
        detail:
          '需給調整市場 (調整力) の ① 6 商品 全体落札単価 ② 蓄電池の商品別落札単価 (FY2024〜、三次② FY2024=109.43 → FY2025=19.31 円/ΔkW・30min) ③ 6 商品 不足率 (FY2024〜) を可視化 (/tracker/imbalance)。出典: EPRX「取引実績の取りまとめ結果」。蓄電池単価は volume 非加重・約定時単価水準 (L-EIC-018 準拠)。',
        metric: '業界唯一性 #15 達成',
      },
      {
