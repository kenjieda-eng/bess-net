/**
 * /buyer/new-entry — 系統用蓄電池ビジネスへの新規参入
...
const config = LANDING_PAGE_CONFIGS['buyer/new-entry'];

export const metadata: Metadata = {
  title: config.title,
  description: config.description,
  alternates: { canonical: '/buyer/new-entry' },
  openGraph: {
    title: config.title,
    description: config.description,
    type: 'website',
...
export default function BuyerNewEntryPage() {
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'これから参入する事業者', item: 'https://bess-net.jp/buyer/new-entry' },
    ],
  };
  return (
    <>
