/**
 * /buyer/ppa-offtake — Sprint X1 Day 2 Buyer Landing
 * PPA・オフテイク契約検討者向け
 */
...
const config = LANDING_PAGE_CONFIGS['buyer/ppa-offtake'];

export const metadata: Metadata = {
  title: config.title,
  description: config.description,
  alternates: { canonical: '/buyer/ppa-offtake' },
  openGraph: {
    title: config.title,
    description: config.description,
    type: 'website',
...
export default function BuyerPpaOfftakePage() {
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'PPA・オフテイク契約検討', item: 'https://bess-net.jp/buyer/ppa-offtake' },
    ],
  };
  return (
    <>
