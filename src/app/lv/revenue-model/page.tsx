 ...
 * 上限価格15→10円は「案・決定前」と明記（L-EIC-019・policy詳細ページと整合）
 */
        ...
        <article className="section-inner article-detail" style={{ maxWidth: 860 }}>
          ...
          <div className="article-body">
            ...
            <ul style={{ paddingLeft: 20, lineHeight: 1.9 }}>
              ...
              <li>
                <strong>【制度動向・未決定】</strong> 一次調整力・二次調整力①・複合商品の上限価格を現行の15円/ΔkW・30分から10円へ引き下げ、2026年9月1日実需給分から適用する案が国の審議会で示されています（2026年7月時点では決定前）。上限付近の約定が多い商品では収益前提に直接影響するため、動向を確認してください（当サイトの詳細ページ: <Link href="/policy-calendar/meti-stable-supply-wg4-balancing-cap-2026-07">第4回 電力安定供給WG ── 上限価格15円→10円引下げ案</Link>／出典: 経済産業省 電力安定供給ワーキンググループ 第4回）。
              </li>
            </ul>
            ...
            <ol style={{ paddingLeft: 20, lineHeight: 1.9 }}>
              <li><strong>市場価格の前提</strong>: どの年度の・どの市場の価格を前提にしているか。上限価格の引下げ案のような制度変更が織り込まれているか。</li>
