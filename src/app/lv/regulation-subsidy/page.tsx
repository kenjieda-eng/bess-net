            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ borderCollapse: 'collapse', width: '100%', marginBottom: 8 }}>
                ...
                <tbody>
                  <tr>
                    <td style={TD}>実施済み</td>
                    <td style={TD}>需給調整市場の低圧開放（2026年4月）／需給調整市場のΔkW上限価格引下げの決定（2026年7月30日公表。一次・二次①・複合商品は8月31日実需給分まで15.00円/ΔkW・30分、9月1日実需給分から10.00円/ΔkW・30分）／特定卸供給事業者（アグリゲーター）制度（2022年施行）／消防関連の規制見直し（2024年）</td>
                  </tr>
                  <tr>
                    <td style={TD}>検討・予定（決定前含む）</td>
                    <td style={TD}>機器のセキュリティ認証 JC-STAR の連系要件化（2027年度から段階適用の見込み・低圧は2027年10月からとされる・詳細要確認）／機器個別計測の運用細部</td>
                  </tr>
                </tbody>
              </table>
            </div>
