...
export const metadata: Metadata = {
  ...
  description:
    '低圧蓄電所（低圧系統用蓄電池）投資のリスクを中立の立場で整理。市場価格の変動、制度変更（上限価格引下げ案）、機器の劣化・故障、事業者リスク、災害・消防、販売資料の利回り表示を読む5つの視点。',
      ...
      <main className="section">
        <article className="section-inner article-detail" style={{ maxWidth: 860 }}>
          ...
          <div className="article-body">
            ...
            <h2>リスク② 制度変更 ── 「上限価格15円→10円案」という実例</h2>
            <ul style={{ paddingLeft: 20, lineHeight: 1.9 }}>
              <li>
                電力市場のルールは毎年のように見直されます。足元の実例が、需給調整市場の一次・二次①・複合商品の上限価格を15円/ΔkW・30分から10円へ引き下げ、2026年9月1日実需給分から適用するという案です（2026年7月時点では決定前）。上限付近の約定が多い商品では、単価前提がそのまま変わりえます（詳細: <Link href="/policy-calendar/meti-stable-supply-wg4-balancing-cap-2026-07">第4回 電力安定供給WG ── 上限価格15円→10円引下げ案</Link>／出典: 経済産業省 電力安定供給WG）。
              </li>
              <li>
            ...
            <ol style={{ paddingLeft: 20, lineHeight: 1.9 }}>
              <li><strong>前提の年度と市場</strong>: どの年の・どの市場価格か。制度変更（上限価格案など）を織り込んでいるか。</li>
              ...
              <li>
                <strong>感応度</strong>: 価格前提が下がったらどうなるか。例えば上限価格が15円から10円になれば、該当商品の単価前提は3分の2です。この試算を販売会社に求めて、答えられるかを見てください。
              </li>
            </ol>
