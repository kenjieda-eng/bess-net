        ...
        <article className="section-inner article-detail" style={{ maxWidth: 860 }}>
          ...
          <div className="article-body">
            ...
            <ol style={{ paddingLeft: 20, lineHeight: 1.9 }}>
              ...
              <li>
                <strong>保安・消防</strong>: リチウムイオン電池の電解液は消防法上の危険物（第4類）に該当するため、設備の容量・電解液量によっては届出等や市町村の火災予防条例に基づく基準が適用される場合があります（近年も規制見直しが継続）。適用の有無は設備構成と自治体により異なるため、所轄消防への確認状況を販売会社に尋ねてください（出典: 総務省消防庁資料）。
              </li>
              <li>
