      ...
      <main className="section">
        <article className="section-inner article-detail" style={{ maxWidth: 860 }}>
          ...
          <div className="article-body">
            ...
            <ul style={{ paddingLeft: 20, lineHeight: 1.9 }}>
              <li>設備の基本構成は、蓄電池本体＋パワーコンディショナー（PCS）＋計量・通信設備。系統から充電し、系統へ放電します。設置面積は商品や台数構成によりますが、数坪〜十数坪規模の区画に収まる商品が主流で、高圧の蓄電所のようなヘクタール級の用地は必要ありません。</li>
              <li>
            ...
            <h2>検討を始める方へ（まとめ）</h2>
            <p>
              低圧蓄電所は「小さく始められる系統用蓄電池事業」ですが、収益は市場価格と制度に依存し、販売資料の前提がそのまま実現するとは限りません。まず収益の構造と利回りの考え方（<Link href="/lv/revenue-model">解説② 収益モデル</Link>・<Link href="/lv/invest/revenue-400-math">売上から手残りまでの計算例</Link>）から確認することをおすすめします。購入を検討中の方はチェックリスト（<Link href="/lv/buying-guide">解説③ 購入・投資ガイド</Link>）も参考にしてください。
            </p>
          </div>
