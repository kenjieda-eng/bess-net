      ...
      <main className="section">
        <article className="section-inner article-detail" style={{ maxWidth: 860 }}>
          ...
          <div className="article-body">
            ...
            <h2>検討を始める方へ（まとめ）</h2>
            <p>
              低圧蓄電所は「小さく始められる系統用蓄電池事業」ですが、収益は市場価格と制度に依存し、販売資料の前提がそのまま実現するとは限りません。まず収益の構造（<Link href="/lv/revenue-model">解説②</Link>）から確認することをおすすめします。購入を検討中の方はチェックリスト（<Link href="/lv/buying-guide">解説③ 購入・投資ガイド</Link>）も参考にしてください。
            </p>
          </div>
