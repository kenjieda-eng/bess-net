      ...
      <main className="section">
        <article className="section-inner article-detail" style={{ maxWidth: 860 }}>
          ...
          >
            ...
            {/* 金曜#7 ⑦(d)（A15 RAUL 開示）: 前例（7/27 SEETEL・新電力ネット 161088 の登壇者欄
                「RAUL株式会社 代表取締役／一般社団法人エネルギー情報センター 理事／江田 健二 氏」）に逐語のある
                兼務だけを書く。★10/14 の一次には同氏の記載が無いため、本セミナーでの役割（司会・登壇等）は書かない。 */}
            なお、主催者の一方であるRAUL株式会社の代表取締役は、当サイトの運営団体である一般社団法人エネルギー情報センターの理事（江田健二 氏）でもあります。
          </div>
