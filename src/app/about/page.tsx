      ...
      <main className="page">
        <div className="page-inner">
          ...
          <section className="page-section">
            ...
            <ul>
              <li>
                <strong>解説</strong>：容量市場・需給調整市場・JEPX・FIP・低圧リソースなどの市場制度や、技術・実務の体系的な解説
              </li>
              <li>
                <strong>用語集</strong>：蓄電所事業に関わる業界用語を解説
              </li>
              <li>
                <strong>ニュース</strong>：業界の最新動向、新規連系・補助金採択・制度改正・事故報告等を継続的に発信（順次公開）
              </li>
              <li>
                <strong>プロジェクトデータベース</strong>：国内の蓄電所プロジェクトを公開情報ベースで一元管理（順次公開）
              </li>
              <li>
                <strong>補助金カレンダー</strong>：経産省・エネ庁・NEDO・SII・自治体の蓄電池関連補助金を継続トラック（順次公開）
              </li>
              <li>
                <strong>変電所別 系統空き容量</strong>：10電力会社が公表する空き容量情報を集約（順次公開）
              </li>
              <li>
                <strong>事業者・サービス一覧</strong>：12カテゴリの事業者を体系的に掲載（順次公開）
              </li>
            </ul>
          </section>
