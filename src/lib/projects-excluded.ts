...
export const EXCLUDED_PROJECT_SLUGS: ReadonlySet<string> = new Set<string>([
  ...
  'pr-co160356-bess-3',
  // 2026-09-08 Pj2-G 追修便（ユウ裁定）: 2案件の混載エントリ。301 ではなく EXCLUDED を選ぶ理由 ——
  //   原典は日経BP「日本蓄電池、岐阜と仙台で蓄電所、TMEICがインテグレート」（2026-04-15）で、
  //   1記事が別々の2施設を並記している（岐阜市太郎丸＝施工ワイ・ジャスト・1月受電／
  //   仙台市上愛子B＝施工ミライト・ワン・4/1受電）。「岐阜・仙台蓄電所」という単一施設は一次に存在せず、
  //   name は記事見出しからの合成。構成2案件はいずれも個別レコードが既存（pr-co161802-gifu／pr-co161802-miyagi）。
