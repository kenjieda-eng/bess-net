...
const EVENTS: Ev[] = [
  ...
  },
  {
    ...
    description:
      '案件番号 620340004。公示 2026-08-14、受付締切 2026-09-12 23:59。再エネ特措法（FIT/FIP）施行規則の一部改正省令案（根拠：同法第9条第3項等）。改正案PDF（様式）には併設蓄電池の記載欄（蓄電池の位置・区分計量の可否等）が含まれる（2026-08-30 編集部確認）。',
