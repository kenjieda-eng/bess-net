...
const BODY = [
  ...
  '<p>8月6日に公表された追加オークションの約定結果（全エリア10,361円/kW、蓄電池13.8万kWが全量約定）は月次バッチで既報のとおりです。次は2026年度メインオークション（対象実需給年度：2030年度）で、応札の受付期間は10月26日〜30日です。→ 記事: <a href="/news/occto-tsuika-auction-fy2027-kekka-2026-08">追加オークション約定結果</a> ／ <a href="/policy-calendar">政策カレンダー</a></p>',
