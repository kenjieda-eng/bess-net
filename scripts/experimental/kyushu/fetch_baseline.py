# -*- coding: utf-8 -*-
"""九州エリアの既存レコードを microCMS から GET してローカル保存（読取専用・書込ゼロ）。
...
while True:
    ...
    offset += 100
    time.sleep(0.4)
json.dump(out, open("scripts/experimental/kyushu/baseline_live.json", "w", encoding="utf-8"),
