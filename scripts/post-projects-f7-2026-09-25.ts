#!/usr/bin/env tsx
/**
 * scripts/post-projects-f7-2026-09-25.ts — 金曜ワンセット#7 ⑤ projects の POST
 *
 * 計画: scripts/pj-f7-post-plan-2026-09-25.json（journal の検証済み出力から機械生成。転記ミス防止）
 ...
 *
 * 実行: set -a && . ./.env.local && set +a && npx tsx scripts/post-projects-f7-2026-09-25.ts [--dry-run]
 */
...
const PLAN = path.join(process.cwd(), 'scripts', 'pj-f7-post-plan-2026-09-25.json');
const LOG = path.join(process.cwd(), 'scripts', 'pj-f7-post-log-2026-09-25.json');
