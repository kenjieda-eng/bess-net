 ...
 *        公式: 容量市場 メインオークション募集要綱（対象実需給年度：2030年度・2026-07-30 版）第3章
 *        「応札の受付期間 2026年10月26日（月）～2026年10月30日（金）」
 *        ★ユウ内部メモの 10/13〜10/23 は「期待容量の審査期間」で応札期間ではない。9-4 便の指示どおり公式実値を正とする。
...
const MAIN_AUCTION = {
  ...
  value: { eventDate: '2026-10-26', endDate: '2026-10-30' },
  why: '募集要綱（対象実需給年度2030年度・2026-07-30版）第3章「応札の受付期間 2026年10月26日（月）～2026年10月30日（金）」',
};
